...
shows marked respiratory sinus arrhythmia, the sinus cycle is estimated \textbf{locally} for
each PVC as the median of nearby N--N intervals. A \textbf{prematurity guard} then excludes PVC
...
\textbf{\pctInterp\%} of measurable PVCs as interpolated and \textbf{\pctComp\%} as compensated,
