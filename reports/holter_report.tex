...
\reportfig{09_cross_session_rhythm_and_burden.png}{Cross-session burden, effective rate vs pause type, composition, and coupling stability.\label{fig:cross}}
\tableCross

\textbf{Key pattern.} The single relationship that ties the dataset together appears in the
effective-rate-vs-pause-type panel of \textbf{Figure~\ref{fig:cross}}: the share of compensated
