...
\reportfig{08_final_2_class_strip.png}{A continuous ECG strip classified by the actual pause \rrpost{} into two classes (no grey zone): \interp{interpolated} (blue) carry no pause, \comp{compensated} (red) are followed by one.\label{fig:strip2}}
