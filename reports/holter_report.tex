...
\reportfig{04_normal_beat_morphology_4_panel_summary.png}{Normal-beat morphology. (a) all N beats overlaid (amplitude-normalised) with the median and IQR; (b) one median waveform per session; (c) pairwise cross-session correlation matrix (all $r\geq0.93$); (d) the most divergent session (06-09 13:23, seated / trunk-flexed) median N against the median and IQR of the other nine.\label{fig:nmorph}}
